...
const RankingTable = () => {
  ...
  const ranking = async () =>{
    ...
    try {
      ...
      const res = await fetch("http://localhost:3078/api/uploadRanking");
  ...
  return (
    <div style={{ maxWidth: 900, margin: "24px auto"}}>
      ...
      {/* Heading */}
      <h2 style={{ marginBottom: 12, textAlign:"center" }}>Rankings</h2>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <thead>
            ...
            <tr style={{ background: "#fafafa" }}>
              ...
              {/* <th style={thStyle} onClick={() => handleSort("Rank_id")}>
                Rank ID <SortIcon colKey="Rank_id" />
              </th> */}
